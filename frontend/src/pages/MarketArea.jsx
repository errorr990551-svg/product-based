  ...
  const marketData = [
    ...
    },
    {
      ...
      cities: [
        ...
        { name: "Bilaspur", link: "/bilaspur-hp" },
    ...
    },
    {
      state: "Jharkhand",
      cities: [
        { name: "Gumla", link: "/gumla" },
        { name: "Lohardaga", link: "/lohardaga" },
        { name: "Chaibasa", link: "/chaibasa" },
        { name: "Sahibganj", link: "/sahibganj" },
        { name: "Giridih", link: "/giridih" },
        { name: "Ramgarh", link: "/ramgarh" },
        { name: "Medininagar", link: "/medininagar" },
        { name: "Deoghar", link: "/deoghar" },
        { name: "Hazaribagh", link: "/hazaribagh" },
        { name: "Phusro", link: "/phusro" },
        { name: "Bokaro Steel City", link: "/bokaro-steel-city" },
        { name: "Mango", link: "/mango" },
        { name: "Dhanbad", link: "/dhanbad" },
        { name: "Ranchi", link: "/ranchi" },
